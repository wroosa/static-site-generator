...
def generate_pages_rescursive(
    ...
    def _gen_pages_recursive(c_path, t_path, d_path, b_path):
        ...
        for item in items:
            ...
            if item.is_dir():
                dest_path.mkdir()
                _gen_pages_recursive(item, t_path, dest_path, b_path)
            elif item.suffix == '.md':
                generate_page(
                    item, 
                    t_path, 
    ...
    return _gen_pages_recursive(cont_path, temp_path, dest_path, base_path)
